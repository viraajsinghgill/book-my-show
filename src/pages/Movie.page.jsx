...
const MoviePage = () => {
  ...
  // const [movie, setMovieContext] =useState(useContext(MovieContext));
  ...
  useEffect(() => {
    ...
    // console.log("vinny" ,requestSimilarMovies())
  }, [id]);
  ...
  useEffect(() => {
    ...
    // console.log("vinny" ,requestRecommendedMovies())
  }, [id]);

  useEffect(() => {
    const requestMovie = async () => {
      const getMovieDate = await axios.get(`/movie/${id}`);
      console.log("vinny", getMovieDate);
      setMovieContext(getMovieDate.data);
    };
    requestMovie();
    // console.log("vinny" ,requestMovie())
  }, [id]);
